...
#conf =SparkConf().setMaster("local").setAppName("Ontime_postgresql_q1").set("spark.executor.memory”,”4G").set("spark.driver.memory","4G")
...
tab1 =sqlContext.read.format("jdbc").options(url="jdbc:postgresql://192.160.156.94:5432/esse3?user=esse3&password=esse3",dbtable="ontime", fetchSize=10000, partitionColumn="year" , lowerBound=2007, upperBound=2017, numPartitions=11).load()
