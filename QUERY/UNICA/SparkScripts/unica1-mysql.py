...
conf = SparkConf().setMaster("spark://spark-master:7077").setAppName("unica1-mysql").set("spark.driver.memory","8g").set("spark.executor.memory","8g").set("spark.sql.inMemoryColumnarStorage.batchSize","100000")
