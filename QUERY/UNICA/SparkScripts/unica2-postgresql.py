...
conf = SparkConf().setMaster("spark://spark-master:7077").setAppName("unica2-postgresql").set("spark.executor.memory","8G").set("spark.driver.memory","8G").set("spark.sql.inMemoryColumnarStorage.batchSize","100000")
