...
conf = SparkConf().setMaster("spark://spark-master:7077").setAppName("unica2-mysql").set("spark.executor.memory","8G").set("spark.driver.memory","8G").set("spark.sql.inMemoryColumnarStorage.batchSize","100000")
...
tab1 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="P02_QUESITI",fetchSize=10000, partitionColumn="QUESTIONARIO_ID" , lowerBound=1, upperBound=78, numPartitions=59).load()
tab1.registerTempTable("P02_QUESITI")


# IMPORT TABLE ELEMENTO_P02_QUESITI
tab2 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="ELEMENTI",fetchSize=2000).load()
tab2.registerTempTable("ELEMENTO_P02_QUESITI")


# IMPORT TABLE ELEMENTO_QUESITI_PADRE 
tab3 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="ELEMENTI",fetchSize=2000).load()
tab3.registerTempTable("ELEMENTO_QUESITI_PADRE")


# IMPORT TABLE P02_RISPOSTE 
tab4 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="P02_RISPOSTE",fetchSize=10000, partitionColumn="QUESITO_ID" , lowerBound=1, upperBound=127341, numPartitions=16).load()
tab4.registerTempTable("P02_RISPOSTE")


# IMPORT TABLE P02_QUEST_COMP_RISPOSTE
tab5 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="P02_QUEST_COMP",fetchSize=10000).load()
tab5.registerTempTable("P02_QUEST_COMP_RISPOSTE")


# IMPORT TABLE V02_RISPOSTE_ROW_TESTO_LIBERO 
tab6 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="V02_RISPOSTE_ROW_TESTO_LIBERO",fetchSize=10000, partitionColumn="QUESITO_ID" , lowerBound=1, upperBound=127341, numPartitions=16).load()
tab6.registerTempTable("V02_RISPOSTE_ROW_TESTO_LIBERO")


# IMPORT TABLE P02_TIPI_FORMATO 
tab7 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="P02_TIPI_FORMATO",fetchSize=10).load()
tab7.registerTempTable("P02_TIPI_FORMATO")


# IMPORT TABLE Q35_DATI_COMP 
tab8 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="Q35_DATI_COMP",fetchSize=100000, partitionColumn="AA_OFF_AD_ID_VAL " , lowerBound=2013, upperBound=2016, numPartitions=5).load()
tab8.registerTempTable("Q35_DATI_COMP")


# IMPORT TABLE Q35_FAC_COMP 
tab9 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="P06_FAC",fetchSize=100).load()
tab9.registerTempTable("Q35_FAC_COMP")


# IMPORT TABLE Q35_CDS_COMP 
tab10 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="P06_CDS",fetchSize=1000).load()
tab10.registerTempTable("Q35_CDS_COMP")


# IMPORT TABLE Q35_DOCENTE_AD_VAL 
tab11 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="DOCENTI",fetchSize=12000).load()
tab11.registerTempTable("Q35_DOCENTE_AD_VAL")


# IMPORT TABLE Q35_DOCENTE_TIT_AD_VAL 
tab12 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="DOCENTI",fetchSize=12000).load()
tab12.registerTempTable("Q35_DOCENTE_TIT_AD_VAL")

# IMPORT TABLE Q35_CDS_AD_VAL
tab13 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="P06_CDS",fetchSize=1000).load()
tab13.registerTempTable("Q35_CDS_AD_VAL")


# IMPORT TABLE Q35_FAC_AD_VAL 
tab14 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="P06_FAC",fetchSize=100).load()
tab14.registerTempTable("Q35_FAC_AD_VAL")


# IMPORT TABLE Q35_P09_AD_GEN
tab15 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="P09_AD_GEN",fetchSize=20000).load()
tab15.registerTempTable("Q35_P09_AD_GEN")


# IMPORT TABLE Q35_SCUOLA  
tab16 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="P01_SCUOLA",fetchSize=15000).load()
tab16.registerTempTable("Q35_SCUOLA")


# IMPORT TABLE Q35_TIPI_TITOLO_SUP 
tab17 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="TIPI_TITOLO_SUP",fetchSize=250).load()
tab17.registerTempTable("Q35_TIPI_TITOLO_SUP")


# IMPORT TABLE Q35_P09_UD_CDS 
tab18 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="P09_UD_CDS",fetchSize=250000).load()
tab18.registerTempTable("Q35_P09_UD_CDS")


# IMPORT TABLE Q35_TIPI_CORSO_AD_VAL 
tab19 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="TIPI_CORSO",fetchSize=60).load()
tab19.registerTempTable("Q35_TIPI_CORSO_AD_VAL")


# IMPORT TABLE Q35_NORMATIVA_CDS_AD_VAL   
tab20 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="P07_NORMATIVA",fetchSize=10).load()
tab20.registerTempTable("Q35_NORMATIVA_CDS_AD_VAL")


# IMPORT TABLE Q35_INVIO_SEGNALAZIONE 
tab21 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="Q35_INVIO_SEGNALAZIONE",fetchSize=10000).load()
tab21.registerTempTable("Q35_INVIO_SEGNALAZIONE")


# IMPORT TABLE Q35_NUM_QUEST_CDS_DOC_UD  
tab22 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="Q35_NUM_QUEST_CDS_DOC_UD",fetchSize=30000).load()
tab22.registerTempTable("Q35_NUM_QUEST_CDS_DOC_UD")


# IMPORT TABLE Q35_CARICHE_FAC_AD_VAL  
tab23 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="V06_CARICHE_SDR_VALIDE",fetchSize=500).load()
tab23.registerTempTable("Q35_CARICHE_FAC_AD_VAL")


# IMPORT TABLE Q35_PRESIDE_FAC_AD_VAL  
tab24 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="DOCENTI",fetchSize=12000).load()
tab24.registerTempTable("Q35_PRESIDE_FAC_AD_VAL")


# IMPORT TABLE Q35_CARICHE_CDS_AD_VAL  
tab25 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="V06_CARICHE_SDR_VALIDE",fetchSize=500).load()
tab25.registerTempTable("Q35_CARICHE_CDS_AD_VAL")


# IMPORT TABLE Q35_PRESIDENTE_CDS_AD_VAL  
tab26 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="DOCENTI",fetchSize=12000).load()
tab26.registerTempTable("Q35_PRESIDENTE_CDS_AD_VAL")


# IMPORT TABLE Q35_DOC_AD_VAL_DIP_AFFERENZA  
tab27 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="P06_DIP",fetchSize=100).load()
tab27.registerTempTable("Q35_DOC_AD_VAL_DIP_AFFERENZA")


# IMPORT TABLE Q35_UD_TIPO_COPERTURA  
tab28 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="P09_UD_PDSORD_DOC",fetchSize=32000).load()
tab28.registerTempTable("Q35_UD_TIPO_COPERTURA")


# IMPORT TABLE QUESITI_PADRE 
tab29 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="P02_QUESITI",fetchSize=10000).load()
tab29.registerTempTable("QUESITI_PADRE")


# IMPORT TABLE Q35_FAC_CDS_AD_VAL
tab30 = sqlContext.read.format("jdbc").options(url="jdbc:mysql://spark-db:3306/ESSE3?user=esse3&password=esse3",dbtable="P06_FAC_CDS",fetchSize=2000).load()
