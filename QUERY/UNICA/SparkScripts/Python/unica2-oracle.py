...
conf = SparkConf().setMaster("local").setAppName("Query2").set("spark.executor.cores", "2").set("spark.executor.memory","4G").set("spark.driver.memory","8G")
...
tab1 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="P02_QUESITI")
tab1.registerTempTable("P02_QUESITI")


# IMPORT TABLE ELEMENTO_P02_QUESITI ------ OK ------- 
tab2 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="ELEMENTI")
tab2.registerTempTable("ELEMENTO_P02_QUESITI")


# IMPORT TABLE ELEMENTO_QUESITI_PADRE  ----- OK -----
tab3 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="ELEMENTI")
tab3.registerTempTable("ELEMENTO_QUESITI_PADRE")


# IMPORT TABLE P02_RISPOSTE ---- OK ----
tab4 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="P02_RISPOSTE")
tab4.registerTempTable("P02_RISPOSTE")


# IMPORT TABLE P02_QUEST_COMP_RISPOSTE ------ OK ------
tab5 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="P02_QUEST_COMP")
tab5.registerTempTable("P02_QUEST_COMP_RISPOSTE")


# IMPORT TABLE V02_RISPOSTE_ROW_TESTO_LIBERO ----- OK ------
tab6 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="V02_RISPOSTE_ROW_TESTO_LIBERO")
tab6.registerTempTable("V02_RISPOSTE_ROW_TESTO_LIBERO")


# IMPORT TABLE P02_TIPI_FORMATO ----- OK ------
tab7 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="P02_TIPI_FORMATO")
tab7.registerTempTable("P02_TIPI_FORMATO")


# IMPORT TABLE Q35_DATI_COMP ------ OK --------
tab8 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="Q35_DATI_COMP")
...
tab9 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="P06_FAC")
tab9.registerTempTable("Q35_FAC_COMP")


# IMPORT TABLE Q35_CDS_COMP ----------- OK ------------
tab10 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="P06_CDS")
tab10.registerTempTable("Q35_CDS_COMP")


# IMPORT TABLE Q35_DOCENTE_AD_VAL ------- OK ---------
tab11 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="DOCENTI")
tab11.registerTempTable("Q35_DOCENTE_AD_VAL")


# IMPORT TABLE Q35_DOCENTE_TIT_AD_VAL -------- OK ---------
tab12 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="DOCENTI")
tab12.registerTempTable("Q35_DOCENTE_TIT_AD_VAL")

# IMPORT TABLE Q35_CDS_AD_VAL -------- OK ----------
tab13 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="P06_CDS")
tab13.registerTempTable("Q35_CDS_AD_VAL")


# IMPORT TABLE Q35_FAC_AD_VAL  -------- OK ---------
tab14 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="P06_FAC")
tab14.registerTempTable("Q35_FAC_AD_VAL")


# IMPORT TABLE Q35_P09_AD_GEN
tab15 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="P09_AD_GEN")
tab15.registerTempTable("Q35_P09_AD_GEN")


# IMPORT TABLE Q35_SCUOLA  ------- OK --------
tab16 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="P01_SCUOLA")
tab16.registerTempTable("Q35_SCUOLA")


# IMPORT TABLE Q35_TIPI_TITOLO_SUP ----- OK -------
tab17 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="TIPI_TITOLO_SUP")
tab17.registerTempTable("Q35_TIPI_TITOLO_SUP")


# IMPORT TABLE Q35_P09_UD_CDS ----- OK -----
tab18 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="P09_UD_CDS")
tab18.registerTempTable("Q35_P09_UD_CDS")


# IMPORT TABLE Q35_TIPI_CORSO_AD_VAL ------ OK --------
tab19 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="TIPI_CORSO")
tab19.registerTempTable("Q35_TIPI_CORSO_AD_VAL")


# IMPORT TABLE Q35_NORMATIVA_CDS_AD_VAL   ------ OK ------
tab20 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="P07_NORMATIVA")
tab20.registerTempTable("Q35_NORMATIVA_CDS_AD_VAL")


# IMPORT TABLE Q35_INVIO_SEGNALAZIONE ------ OK -----
tab21 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="Q35_INVIO_SEGNALAZIONE")
tab21.registerTempTable("Q35_INVIO_SEGNALAZIONE")


# IMPORT TABLE Q35_NUM_QUEST_CDS_DOC_UD  ------- OK ---------
tab22 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="Q35_NUM_QUEST_CDS_DOC_UD")
tab22.registerTempTable("Q35_NUM_QUEST_CDS_DOC_UD")


# IMPORT TABLE Q35_CARICHE_FAC_AD_VAL  ------ OK -------
tab23 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="V06_CARICHE_SDR_VALIDE")
tab23.registerTempTable("Q35_CARICHE_FAC_AD_VAL")


# IMPORT TABLE Q35_PRESIDE_FAC_AD_VAL  ------ OK ------
tab24 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="DOCENTI")
tab24.registerTempTable("Q35_PRESIDE_FAC_AD_VAL")


# IMPORT TABLE Q35_CARICHE_CDS_AD_VAL   -------- OK --------
tab25 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="V06_CARICHE_SDR_VALIDE")
tab25.registerTempTable("Q35_CARICHE_CDS_AD_VAL")


# IMPORT TABLE Q35_PRESIDENTE_CDS_AD_VAL  ------ OK ------
tab26 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="DOCENTI")
tab26.registerTempTable("Q35_PRESIDENTE_CDS_AD_VAL")


# IMPORT TABLE Q35_DOC_AD_VAL_DIP_AFFERENZA   ------- OK --------
tab27 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="P06_DIP")
tab27.registerTempTable("Q35_DOC_AD_VAL_DIP_AFFERENZA")


# IMPORT TABLE Q35_UD_TIPO_COPERTURA  ------- OK -------
tab28 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="P09_UD_PDSORD_DOC")
tab28.registerTempTable("Q35_UD_TIPO_COPERTURA")


# IMPORT TABLE QUESITI_PADRE ----- OK -----
tab29 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="P02_QUESITI")
tab29.registerTempTable("QUESITI_PADRE")


# IMPORT TABLE Q35_FAC_CDS_AD_VAL
tab30 = sqlContext.load(source="jdbc",url="jdbc:oracle:thin:esse3/esse3@//localhost:1521/orcl.unica.it",dbtable="P06_FAC_CDS")
