...
#conf = SparkConf().setMaster("local").setAppName("Query1").set("spark.executor.cores", "4").set("spark.executor.memory","6G").set("spark.driver.memory","12G").set("spark.driver-cores","4").set("spark.num_executors","16").set("spark.sql.codegen","true").set("spark.sql.inMemoryColumnarStorage.com","true").set("spark.sql.inMemoryColumnarStorageBatch","10000").set("spark.sql.parquet.compression.codec","snappy").set("spark.executor.extraJavaOptions","-XX:MaxPermSize=1G").set("spark.driver-java-options","-XX:MaxPermSize=1G")

conf = SparkConf().setMaster("local").setAppName("Query1").set("spark.driver.memory","8G").set("spark.executor.memory","6G").set("spark.num_executors","80")
...
file1 = sc.textFile("/root/ARE2/Q1/CSV/P02_QUESITI.csv")
...
file2 = sc.textFile("/root/ARE2/Q1/CSV/ELEMENTI.csv") 
...
file3 = sc.textFile("/root/ARE2/Q1/CSV/ELEMENTI.csv")
...
file4 = sc.textFile("/root/ARE2/Q1/CSV/P02_RISPOSTE.csv")
...
file5 = sc.textFile("/root/ARE2/Q1/CSV/P02_QUEST_COMP.csv")
...
file6 = sc.textFile("/root/ARE2/Q1/CSV/V02_RISPOSTE_ROW_TESTO_LIBERO.csv")
...
file7 = sc.textFile("/root/ARE2/Q1/CSV/P02_TIPI_FORMATO.csv")
...
file8 = sc.textFile("/root/ARE2/Q1/CSV/Q35_DATI_COMP.csv")
...
file9 = sc.textFile("/root/ARE2/Q1/CSV/P06_FAC.csv")
...
file10 = sc.textFile("/root/ARE2/Q1/CSV/P06_CDS.csv")
...
file11 = sc.textFile("/root/ARE2/Q1/CSV/DOCENTI.csv")
...
file12 = sc.textFile("/root/ARE2/Q1/CSV/DOCENTI.csv")
...
file13 = sc.textFile("/root/ARE2/Q1/CSV/P06_CDS.csv")
...
file14 = sc.textFile("/root/ARE2/Q1/CSV/P06_FAC.csv")
...
file15 = sc.textFile("/root/ARE2/Q1/CSV/P09_AD_GEN.csv")
...
file16 = sc.textFile("/root/ARE2/Q1/CSV/P01_SCUOLA.csv")
...
file17 = sc.textFile("/root/ARE2/Q1/CSV/TIPI_TITOLO_SUP.csv")
...
file18 = sc.textFile("/root/ARE2/Q1/CSV/P09_UD_CDS.csv")
...
file19 = sc.textFile("/root/ARE2/Q1/CSV/TIPI_CORSO.csv")
...
file20 = sc.textFile("/root/ARE2/Q1/CSV/P07_NORMATIVA.csv")
...
file21 = sc.textFile("/root/ARE2/Q1/CSV/Q35_INVIO_SEGNALAZIONE.csv")
...
file22 = sc.textFile("/root/ARE2/Q1/CSV/Q35_NUM_QUEST_CDS_DOC_UD.csv")
...
file23 = sc.textFile("/root/ARE2/Q1/CSV/V06_CARICHE_SDR_VALIDE.csv")
...
file24 = sc.textFile("/root/ARE2/Q1/CSV/DOCENTI.csv")
...
file25 = sc.textFile("/root/ARE2/Q1/CSV/V06_CARICHE_SDR_VALIDE.csv")
...
file26 = sc.textFile("/root/ARE2/Q1/CSV/DOCENTI.csv")
...
file27 = sc.textFile("/root/ARE2/Q1/CSV/P06_DIP.csv")
...
file28 = sc.textFile("/root/ARE2/Q1/CSV/P09_UD_PDSORD_DOC.csv")
...
file29 = sc.textFile("/root/ARE2/Q1/CSV/P02_QUESITI.csv")
...
file30 = sc.textFile("/root/ARE2/Q1/CSV/P06_FAC_CDS.csv")
...
#q1 = sqlContext.sql("SELECT P02_QUESITI.QUESTIONARIO_ID,P02_QUESITI.QUESITO_ID,P02_QUESITI.PARENT_QUESITO_ID,P02_QUESITI.ORD_VIS, P02_QUESITI.ELEM_COD, ELEMENTO_P02_QUESITI.DES, ELEMENTO_QUESITI_PADRE.DES, P02_QUESITI.OBBLIGATORIO_FLG, P02_RISPOSTE.RISPOSTA_ID, P02_RISPOSTE.QUEST_COMP_ID, STATO_QUEST_COD, TESTO_LIBERO, V02_RISPOSTE_ROW_TESTO_LIBERO.RISPOSTA_ID, V02_RISPOSTE_ROW_TESTO_LIBERO.QUESITO_ID, V02_RISPOSTE_ROW_TESTO_LIBERO.QUEST_COMP_ID, N_RIGA_TESTO_LIBERO, RIGA_TESTO_LIBERO, P02_QUESITI.TIPO_FORMATO_COD, P02_TIPI_FORMATO.DES, FAC_ID_COMP, Q35_FAC_COMP.COD, Q35_FAC_COMP.DES, CDS_ID_COMP, Q35_CDS_COMP.COD, Q35_CDS_COMP.DES, AA_ID_COMP, Q35_DATI_COMP.AD_ID_VAL, Q35_DATI_COMP.DOC_AD_ID_VAL, Q35_DOCENTE_AD_VAL.MATRICOLA, DOC_TIT_AD_ID_VAL, Q35_DOCENTE_TIT_AD_VAL.MATRICOLA, DOM_PART_AD_COD_VAL, FAT_PART_AD_COD_VAL, PART_AD_COD_VAL, DATAORA_COMP, Q35_DATI_COMP.EVENTO_COMP, Q35_DATI_COMP.STU_FREQ_FLG_COMP, Q35_DATI_COMP.STU_NO_AUT_FLG_COMP, Q35_DATI_COMP.UD_ID_VAL, Q35_DATI_COMP.QUEST_COMP_ID, Q35_DATI_COMP.AA_OFF_AD_ID_VAL, AA_ISCR_ID_COMP, ANNO_CORSO_AD_VAL, Q35_DATI_COMP.CDS_AD_ID_VAL, Q35_CDS_AD_VAL.COD, Q35_CDS_AD_VAL.DES, Q35_FAC_AD_VAL.COD, Q35_FAC_AD_VAL.DES, Q35_P09_AD_GEN.COD, Q35_P09_AD_GEN.DES, Q35_DATI_COMP.SCUOLA_SUP_ID_COMP, AA_CFU_STU_COMP, AA_IMM1_COMP, AA_IMM_SU_COMP, AA_ORD_AD_ID_VAL, AA_ORD_ID_COMP, ANNO_CORSO_COMP, ANNO_MATUR_COMP, ANNO_NASCITA_COMP, CITT_COD_COMP, CFU_AA_STU_COMP, CFU_ACQ_STU_COMP, LODE_MATUR_FLG_COMP, MEDIA_STU_COMP, NAZ_MATUR_ID_COMP, NAZ_ORD_TIT_ID_COMP, NAZ_RES_ID_COMP, PDS_AD_ID_VAL, PDS_ID_COMP, PROF_COD_COMP, PROV_NASC_COMP, PROV_RES_COMP, Q35_SCUOLA.DES, SEDE_ID_COMP, SESSO_COMP, TIPO_DID_COD_COMP, TIPO_ISCR_COD_COMP, Q35_DATI_COMP.TIPO_TITOLO_COD_COMP, TIPO_TITST_COD_COMP, Q35_TIPI_TITOLO_SUP.DES, Q35_TIPI_TITOLO_SUP.TIPOLOGIA_COD, Q35_TIPI_TITOLO_SUP.TIPOLOGIA_COD, Q35_TIPI_TITOLO_SUP.TIPOLOGIA_COD, Q35_SCUOLA.DES, Q35_P09_UD_CDS.COD, Q35_P09_UD_CDS.DES, VOTO_ALFA_MATUR_COMP, VOTO_MATUR_COMP, VOTO_MAX_MATUR_COMP, VOTO_MIN_MATUR_COMP, Q35_CDS_AD_VAL.TIPO_CORSO_COD, TIPO_CORSO_DES, DURATA_ANNI, NORM_COD, FLAG_SEGNALA_COORD_CDS, FLAG_SEGNALA_PRES_FAC, FLAG_SEGNALA_PRES_NUCLEO, NUM_QUEST_COMP, Q35_CARICHE_FAC_AD_VAL.SDR_TIP, Q35_CARICHE_FAC_AD_VAL.COD, Q35_CARICHE_FAC_AD_VAL.DES, Q35_CARICHE_FAC_AD_VAL.MATRICOLA_DOCENTE, Q35_CARICHE_FAC_AD_VAL.DES_CARICA, Q35_CARICHE_FAC_AD_VAL.TIPO_SOGG, Q35_CARICHE_FAC_AD_VAL.CARICA_ID, Q35_CARICHE_FAC_AD_VAL.DATA_INIZIO_VAL, Q35_CARICHE_FAC_AD_VAL.DATA_FINE_VAL, Q35_CARICHE_CDS_AD_VAL.SDR_TIP, Q35_CARICHE_CDS_AD_VAL.COD, Q35_CARICHE_CDS_AD_VAL.DES, Q35_CARICHE_CDS_AD_VAL.MATRICOLA_DOCENTE, Q35_CARICHE_CDS_AD_VAL.DES_CARICA, Q35_CARICHE_CDS_AD_VAL.TIPO_SOGG, Q35_CARICHE_CDS_AD_VAL.CARICA_ID, Q35_CARICHE_CDS_AD_VAL.DATA_INIZIO_VAL, Q35_CARICHE_CDS_AD_VAL.DATA_FINE_VAL, Q35_DOCENTE_AD_VAL.DIP_ID, Q35_DOC_AD_VAL_DIP_AFFERENZA.COD, Q35_DOC_AD_VAL_DIP_AFFERENZA.DES, TIPO_COPERTURA_COD, TIPO_COPERTURA_COD FROM P02_QUESITI LEFT OUTER JOIN P02_TIPI_FORMATO ON (P02_QUESITI.TIPO_FORMATO_COD = P02_TIPI_FORMATO.TIPO_FORMATO_COD) LEFT OUTER JOIN ELEMENTO_P02_QUESITI ON (P02_QUESITI.ELEM_COD = ELEMENTO_P02_QUESITI.ELEM_COD) LEFT OUTER JOIN P02_RISPOSTE ON (P02_QUESITI.QUESITO_ID = P02_RISPOSTE.QUESITO_ID) LEFT OUTER JOIN P02_QUEST_COMP_RISPOSTE ON (P02_RISPOSTE.QUEST_COMP_ID = P02_QUEST_COMP_RISPOSTE.QUEST_COMP_ID) LEFT OUTER JOIN P02_QUESITI QUESITI_PADRE ON (P02_QUESITI.PARENT_QUESITO_ID = QUESITI_PADRE.QUESITO_ID) LEFT OUTER JOIN ELEMENTO_QUESITI_PADRE ON (QUESITI_PADRE.ELEM_COD = ELEMENTO_QUESITI_PADRE.ELEM_COD) JOIN V02_RISPOSTE_ROW_TESTO_LIBERO ON (P02_RISPOSTE.RISPOSTA_ID = V02_RISPOSTE_ROW_TESTO_LIBERO.RISPOSTA_ID) LEFT OUTER JOIN Q35_DATI_COMP ON (P02_RISPOSTE.QUEST_COMP_ID = Q35_DATI_COMP.QUEST_COMP_ID) LEFT OUTER JOIN Q35_CDS_AD_VAL ON (Q35_DATI_COMP.CDS_AD_ID_VAL = Q35_CDS_AD_VAL.CDS_ID) JOIN Q35_FAC_CDS_AD_VAL ON ((Q35_CDS_AD_VAL.CDS_ID = Q35_FAC_CDS_AD_VAL.CDS_ID) AND Q35_FAC_CDS_AD_VAL.DEF_AMM_FLG=1) LEFT OUTER JOIN Q35_FAC_AD_VAL ON (Q35_FAC_CDS_AD_VAL.FAC_ID = Q35_FAC_AD_VAL.FAC_ID) LEFT OUTER JOIN Q35_DOCENTE_AD_VAL ON (Q35_DATI_COMP.DOC_AD_ID_VAL = Q35_DOCENTE_AD_VAL.DOCENTE_ID) LEFT OUTER JOIN Q35_DOCENTE_TIT_AD_VAL ON (Q35_DATI_COMP.DOC_TIT_AD_ID_VAL = Q35_DOCENTE_TIT_AD_VAL.DOCENTE_ID) LEFT OUTER JOIN Q35_FAC_COMP ON (Q35_DATI_COMP.FAC_ID_COMP = Q35_FAC_COMP.FAC_ID) LEFT OUTER JOIN Q35_CDS_COMP ON (Q35_DATI_COMP.CDS_ID_COMP = Q35_CDS_COMP.CDS_ID) LEFT OUTER JOIN Q35_P09_AD_GEN ON (Q35_DATI_COMP.AD_ID_VAL = Q35_P09_AD_GEN.AD_ID) LEFT OUTER JOIN Q35_P09_UD_CDS ON ((Q35_DATI_COMP.AA_OFF_AD_ID_VAL = Q35_P09_UD_CDS.AA_OFF_ID) AND (Q35_DATI_COMP.AD_ID_VAL = Q35_P09_UD_CDS.AD_ID) AND (Q35_DATI_COMP.CDS_AD_ID_VAL = Q35_P09_UD_CDS.CDS_ID) AND (Q35_DATI_COMP.UD_ID_VAL = Q35_P09_UD_CDS.UD_ID)) LEFT OUTER JOIN Q35_TIPI_TITOLO_SUP ON (Q35_DATI_COMP.TIPO_TITOLO_COD_COMP = Q35_TIPI_TITOLO_SUP.TIPO_TITOLO_COD) LEFT OUTER JOIN Q35_SCUOLA ON (Q35_DATI_COMP.SCUOLA_SUP_ID_COMP = Q35_SCUOLA.SCUOLA_SUP_ID) LEFT OUTER JOIN Q35_TIPI_CORSO_AD_VAL ON (Q35_CDS_AD_VAL.TIPO_CORSO_COD = Q35_TIPI_CORSO_AD_VAL.TIPO_CORSO_COD) LEFT OUTER JOIN Q35_NORMATIVA_CDS_AD_VAL ON (Q35_CDS_AD_VAL.NORM_ID = Q35_NORMATIVA_CDS_AD_VAL.NORM_ID) LEFT OUTER JOIN Q35_INVIO_SEGNALAZIONE ON (Q35_DATI_COMP.QUEST_COMP_ID = Q35_INVIO_SEGNALAZIONE.QUEST_COMP_ID) LEFT OUTER JOIN Q35_CARICHE_CDS_AD_VAL ON ((Q35_FAC_CDS_AD_VAL.CDS_ID = Q35_CARICHE_CDS_AD_VAL.STRUTT_ID) AND Q35_CARICHE_CDS_AD_VAL.SDR_TIP='CDS' AND Q35_CARICHE_CDS_AD_VAL.CARICA_ID=95) LEFT OUTER JOIN Q35_CARICHE_FAC_AD_VAL ON ((Q35_FAC_CDS_AD_VAL.FAC_ID = Q35_CARICHE_FAC_AD_VAL.STRUTT_ID) AND Q35_CARICHE_FAC_AD_VAL.SDR_TIP='FAC' AND Q35_CARICHE_FAC_AD_VAL.CARICA_ID=97) LEFT OUTER JOIN Q35_PRESIDE_FAC_AD_VAL ON (Q35_CARICHE_FAC_AD_VAL.MATRICOLA_DOCENTE = Q35_PRESIDE_FAC_AD_VAL.MATRICOLA) LEFT OUTER JOIN Q35_PRESIDENTE_CDS_AD_VAL ON (Q35_CARICHE_CDS_AD_VAL.MATRICOLA_DOCENTE = Q35_PRESIDENTE_CDS_AD_VAL.MATRICOLA) LEFT OUTER JOIN Q35_NUM_QUEST_CDS_DOC_UD ON ((Q35_DATI_COMP.AA_OFF_AD_ID_VAL = Q35_NUM_QUEST_CDS_DOC_UD.AA_OFF_AD_ID_VAL) AND (Q35_DATI_COMP.AD_ID_VAL = Q35_NUM_QUEST_CDS_DOC_UD.AD_ID_VAL) AND (Q35_DATI_COMP.CDS_AD_ID_VAL = Q35_NUM_QUEST_CDS_DOC_UD.CDS_AD_ID_VAL) AND (Q35_DATI_COMP.DOC_AD_ID_VAL = Q35_NUM_QUEST_CDS_DOC_UD.DOC_AD_ID_VAL) AND (Q35_DATI_COMP.UD_ID_VAL = Q35_NUM_QUEST_CDS_DOC_UD.UD_ID_VAL) AND  (NVL(Q35_DATI_COMP.EVENTO_COMP,'BOZZA')=Q35_NUM_QUEST_CDS_DOC_UD.EVENTO_COMP) AND  (NVL(Q35_DATI_COMP.STU_FREQ_FLG_COMP,999)=Q35_NUM_QUEST_CDS_DOC_UD.STU_FREQ_FLG_COMP) AND  (NVL(Q35_DATI_COMP.STU_NO_AUT_FLG_COMP,999)=Q35_NUM_QUEST_CDS_DOC_UD.STU_NO_AUT_FLG_COMP)) LEFT OUTER JOIN Q35_DOC_AD_VAL_DIP_AFFERENZA ON (Q35_DOC_AD_VAL_DIP_AFFERENZA.DIP_ID = Q35_DOCENTE_AD_VAL.DIP_ID) LEFT OUTER JOIN Q35_UD_TIPO_COPERTURA ON ((Q35_DATI_COMP.AA_OFF_AD_ID_VAL = Q35_UD_TIPO_COPERTURA.AA_OFF_ID) AND (Q35_DATI_COMP.AA_ORD_AD_ID_VAL = Q35_UD_TIPO_COPERTURA.AA_ORD_ID) AND (Q35_DATI_COMP.AD_ID_VAL = Q35_UD_TIPO_COPERTURA.AD_ID) AND (Q35_DATI_COMP.CDS_AD_ID_VAL = Q35_UD_TIPO_COPERTURA.CDS_ID) AND (Q35_DATI_COMP.DOC_AD_ID_VAL = Q35_UD_TIPO_COPERTURA.DOCENTE_ID) AND (Q35_DATI_COMP.PDS_AD_ID_VAL = Q35_UD_TIPO_COPERTURA.PDS_ID) AND (Q35_DATI_COMP.UD_ID_VAL = Q35_UD_TIPO_COPERTURA.UD_ID)) WHERE ((P02_QUESITI.QUESTIONARIO_ID = 35) AND ((Q35_DATI_COMP.AA_OFF_AD_ID_VAL = '2016') AND (Q35_DATI_COMP.DATAORA_COMP < CAST('2016-12-31 00:00:00' AS DATE))))")
