...
conf = SparkConf().setMaster("spark://192.167.155.71:7077").setAppName("unica2-oracle").set("spark.executor.memory","4G").set("spark.driver.memory","4G")
...
tab1 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="P02_QUESITI",fetchSize=10000).load()
tab1.registerTempTable("P02_QUESITI")


# IMPORT TABLE ELEMENTO_P02_QUESITI ------ OK ------- 
tab2 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="ELEMENTI",fetchSize=10000).load()
tab2.registerTempTable("ELEMENTO_P02_QUESITI")


# IMPORT TABLE ELEMENTO_QUESITI_PADRE  ----- OK -----
tab3 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="ELEMENTI",fetchSize=10000).load()
tab3.registerTempTable("ELEMENTO_QUESITI_PADRE")


# IMPORT TABLE P02_RISPOSTE ---- OK ----
tab4 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="P02_RISPOSTE",fetchSize=10000,partitionColumn="QUESITO_ID" , lowerBound=232, upperBound=12734, numPartitions=100).load()
tab4.registerTempTable("P02_RISPOSTE")


# IMPORT TABLE P02_QUEST_COMP_RISPOSTE ------ OK ------
tab5 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="P02_QUEST_COMP",fetchSize=10000).load()
tab5.registerTempTable("P02_QUEST_COMP_RISPOSTE")


# IMPORT TABLE V02_RISPOSTE_ROW_TESTO_LIBERO ----- OK ------
tab6 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="V02_RISPOSTE_ROW_TESTO_LIBERO",fetchSize=10000,partitionColumn="QUESITO_ID" , lowerBound=232, upperBound=12734, numPartitions=100).load()
tab6.registerTempTable("V02_RISPOSTE_ROW_TESTO_LIBERO")


# IMPORT TABLE P02_TIPI_FORMATO ----- OK ------
tab7 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="P02_TIPI_FORMATO",fetchSize=10000).load()
tab7.registerTempTable("P02_TIPI_FORMATO")


# IMPORT TABLE Q35_DATI_COMP ------ OK --------
tab8 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="Q35_DATI_COMP",fetchSize=10000).load()
...
tab9 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="P06_FAC",fetchSize=10000).load()
tab9.registerTempTable("Q35_FAC_COMP")


# IMPORT TABLE Q35_CDS_COMP ----------- OK ------------
tab10 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="P06_CDS",fetchSize=10000).load()
tab10.registerTempTable("Q35_CDS_COMP")


# IMPORT TABLE Q35_DOCENTE_AD_VAL ------- OK ---------
tab11 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="DOCENTI",fetchSize=10000).load()
tab11.registerTempTable("Q35_DOCENTE_AD_VAL")


# IMPORT TABLE Q35_DOCENTE_TIT_AD_VAL -------- OK ---------
tab12 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="DOCENTI",fetchSize=10000).load()
tab12.registerTempTable("Q35_DOCENTE_TIT_AD_VAL")

# IMPORT TABLE Q35_CDS_AD_VAL -------- OK ----------
tab13 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="P06_CDS",fetchSize=10000).load()
tab13.registerTempTable("Q35_CDS_AD_VAL")


# IMPORT TABLE Q35_FAC_AD_VAL  -------- OK ---------
tab14 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="P06_FAC",fetchSize=10000).load()
tab14.registerTempTable("Q35_FAC_AD_VAL")


# IMPORT TABLE Q35_P09_AD_GEN
tab15 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="P09_AD_GEN",fetchSize=10000).load()
tab15.registerTempTable("Q35_P09_AD_GEN")


# IMPORT TABLE Q35_SCUOLA  ------- OK --------
tab16 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="P01_SCUOLA",fetchSize=10000).load()
tab16.registerTempTable("Q35_SCUOLA")


# IMPORT TABLE Q35_TIPI_TITOLO_SUP ----- OK -------
tab17 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="TIPI_TITOLO_SUP",fetchSize=10000).load()
tab17.registerTempTable("Q35_TIPI_TITOLO_SUP")


# IMPORT TABLE Q35_P09_UD_CDS ----- OK -----
tab18 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="P09_UD_CDS",fetchSize=10000).load()
tab18.registerTempTable("Q35_P09_UD_CDS")


# IMPORT TABLE Q35_TIPI_CORSO_AD_VAL ------ OK --------
tab19 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="TIPI_CORSO",fetchSize=10000).load()
tab19.registerTempTable("Q35_TIPI_CORSO_AD_VAL")


# IMPORT TABLE Q35_NORMATIVA_CDS_AD_VAL   ------ OK ------
tab20 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="P07_NORMATIVA",fetchSize=10000).load()
tab20.registerTempTable("Q35_NORMATIVA_CDS_AD_VAL")


# IMPORT TABLE Q35_INVIO_SEGNALAZIONE ------ OK -----
tab21 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="Q35_INVIO_SEGNALAZIONE,fetchSize=10000).load()
tab21.registerTempTable("Q35_INVIO_SEGNALAZIONE")


# IMPORT TABLE Q35_NUM_QUEST_CDS_DOC_UD  ------- OK ---------
tab22 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="Q35_NUM_QUEST_CDS_DOC_UD",fetchSize=10000).load()
tab22.registerTempTable("Q35_NUM_QUEST_CDS_DOC_UD")


# IMPORT TABLE Q35_CARICHE_FAC_AD_VAL  ------ OK -------
tab23 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="V06_CARICHE_SDR_VALIDE",fetchSize=10000).load()
tab23.registerTempTable("Q35_CARICHE_FAC_AD_VAL")


# IMPORT TABLE Q35_PRESIDE_FAC_AD_VAL  ------ OK ------
tab24 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="DOCENTI",fetchSize=10000).load()
tab24.registerTempTable("Q35_PRESIDE_FAC_AD_VAL")


# IMPORT TABLE Q35_CARICHE_CDS_AD_VAL   -------- OK --------
tab25 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="V06_CARICHE_SDR_VALIDE",fetchSize=10000).load()
tab25.registerTempTable("Q35_CARICHE_CDS_AD_VAL")


# IMPORT TABLE Q35_PRESIDENTE_CDS_AD_VAL  ------ OK ------
tab26 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="DOCENTI",fetchSize=10000).load()
tab26.registerTempTable("Q35_PRESIDENTE_CDS_AD_VAL")


# IMPORT TABLE Q35_DOC_AD_VAL_DIP_AFFERENZA   ------- OK --------
tab27 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="P06_DIP",fetchSize=10000).load()
tab27.registerTempTable("Q35_DOC_AD_VAL_DIP_AFFERENZA")


# IMPORT TABLE Q35_UD_TIPO_COPERTURA  ------- OK -------
tab28 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="P09_UD_PDSORD_DOC",fetchSize=10000).load()
tab28.registerTempTable("Q35_UD_TIPO_COPERTURA")


# IMPORT TABLE QUESITI_PADRE ----- OK -----
tab29 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="P02_QUESITI",fetchSize=10000).load()
tab29.registerTempTable("QUESITI_PADRE")


# IMPORT TABLE Q35_FAC_CDS_AD_VAL
tab30 = sqlContext.read.format("jdbc").options(url="jdbc:oracle:thin:esse3/esse3@//192.160.156.94:1521/orcl.unica.it",dbtable="P06_FAC_CDS",fetchSize=10000).load()
