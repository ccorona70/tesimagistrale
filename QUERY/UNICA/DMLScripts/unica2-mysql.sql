...
LEFT OUTER JOIN Q35_NUM_QUEST_CDS_DOC_UD 
    ...
    AND  (IFNULL(Q35_DATI_COMP.EVENTO_COMP,'BOZZA')=Q35_NUM_QUEST_CDS_DOC_UD.EVENTO_COMP) 
	AND  (IFNULL(Q35_DATI_COMP.STU_FREQ_FLG_COMP,999)=Q35_NUM_QUEST_CDS_DOC_UD.STU_FREQ_FLG_COMP) 
	AND  (IFNULL(Q35_DATI_COMP.STU_NO_AUT_FLG_COMP,999)=Q35_NUM_QUEST_CDS_DOC_UD.STU_NO_AUT_FLG_COMP))
...
LEFT OUTER JOIN P09_UD_PDSORD_DOC Q35_UD_TIPO_COPERTURA ON ((Q35_DATI_COMP.AA_OFF_AD_ID_VAL = Q35_UD_TIPO_COPERTURA.AA_OFF_ID)
    ...
    WHERE ((P02_QUESITI.QUESTIONARIO_ID = 35) 
        ...
        AND (Q35_DATI_COMP.DATAORA_COMP < STR_TO_DATE('31/12/2013','%d/%m/%Y'))) OR
 ((Q35_DATI_COMP.AA_OFF_AD_ID_VAL = '2014') 
        AND (Q35_DATI_COMP.DATAORA_COMP < STR_TO_DATE('31/12/2014','%d/%m/%Y'))) OR
 ((Q35_DATI_COMP.AA_OFF_AD_ID_VAL = '2015') 
        AND (Q35_DATI_COMP.DATAORA_COMP < STR_TO_DATE('31/12/2015','%d/%m/%Y'))) OR
