...
SELECT 
Q35_DATI_COMP.AA_OFF_AD_ID_VAL,
substr(Q35_FAC_COMP.DES,1,50),
count(P02_RISPOSTE.RISPOSTA_ID) tot_risposte
...
Q35_DATI_COMP.AA_OFF_AD_ID_VAL,
Q35_FAC_COMP.DES
having count(P02_RISPOSTE.RISPOSTA_ID)>200000
order by Q35_DATI_COMP.AA_OFF_AD_ID_VAL,count(P02_RISPOSTE.RISPOSTA_ID) desc;
